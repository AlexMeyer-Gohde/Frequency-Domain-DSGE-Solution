...
param = [2.09 0.6530 2.00 0.65 0.76 3.08 0.55 1.5 4 2.5 0.19 0.65 0.5]; % starting values
...
[fh,x,gh,H,itct,fcount,retcodeh] = csminwel('objectiveconstr',param',eye(13)*1e-5,[] ,10^(-8),200);
...
Theta(2) = exp(Theta(2))/(1+exp(Theta(2)));%ln(Theta(2))=x-l
