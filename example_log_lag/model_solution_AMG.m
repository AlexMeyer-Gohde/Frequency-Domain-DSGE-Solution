...
input.D_z=@(z)[-log(1 - rho_z*z)./rho_z 0 0; 0 -log(1 - rho_g*z)./rho_g 0; 0 0 z];
input.D_z_i{1}=@(z)[-1./(rho_z*z - 1) 0 0; 0 -1./(rho_g*z - 1) 0; 0 0 1];
input.D_z_i{2}=@(z)[rho_z./(rho_z*z - 1).^2 0 0; 0 rho_g./(rho_g*z - 1).^2  0; 0 0 0];
input.D_z_i{3}=@(z)[-(2*rho_z^2)./(rho_z.*z - 1).^3 0 0; 0 -(2*rho_g^2)./(rho_g.*z - 1).^3 0; 0 0 0];
