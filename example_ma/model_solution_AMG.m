...
input.D_z=@(z)[z.*(rho_z_0-rho_z_1.*z) 0 0; 0 z.*(rho_g_0-rho_g_1.*z) 0; 0 0 z];
input.D_z_i{1}=@(z)[rho_z_0-2*rho_z_1*z 0 0; 0 rho_g_0-2*rho_g_1*z 0; 0 0 1];
input.D_z_i{2}=@(z)[-2*rho_z_1 0 0; 0 -2*rho_g_1  0; 0 0 0];
input.D_z_i{3}=@(z)[0 0 0; 0 0  0; 0 0 0];
