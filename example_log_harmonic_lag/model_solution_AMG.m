...
input.D_z=@(z)[-log(1-rho_z.*z)./((1-rho_z.*z).*(rho_z)) 0 0; 0 -log(1-rho_g.*z)./((1-rho_g.*z).*(rho_g)) 0; 0 0 z];
input.D_z_i{1}=@(z)[-(log(1 - rho_z*z) - 1)./(rho_z*z - 1).^2 0 0; 0 -(log(1 - rho_g*z) - 1)./(rho_g*z - 1).^2 0; 0 0 1];
input.D_z_i{2}=@(z)[(rho_z*(2*log(1 - rho_z*z) - 3))./(rho_z*z - 1).^3 0 0; 0 (rho_g*(2*log(1 - rho_g*z) - 3))./(rho_g*z - 1).^3  0; 0 0 0];
input.D_z_i{3}=@(z)[-(rho_z^2*(6*log(1 - rho_z.*z) - 11))./(rho_z.*z - 1).^4 0 0; 0 -(rho_g^2*(6*log(1 - rho_g.*z) - 11))./(rho_g.*z - 1).^4  0; 0 0 0];
